...
public class MAIN {
    ...
    public static double testClassManagement() {
        ...
        try {
            ...
            Class added_class = (Class)trainer.getListOfClasses().get(0);
            if (registered && added_class.getAvailableSeats() == 0 && trainer.getListOfRegistrations().get(0).getSearchKey().equals("M001C001")) {
    ...
    public static double testRegistrationManagement() {
        ...
        try {
            ...
            Class cancelled_class = (Class)trainer.getListOfClasses().get(1);
            if (cancelled && cancelled_class.getAvailableSeats() == 30) {
